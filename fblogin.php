...
<form width="100%" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
<input class="input1" type="text" name="email"  placeholder="email address or phone number "/><br>
<input class="input2" type="password" name="password" placeholder="password"/><br>
<br>
